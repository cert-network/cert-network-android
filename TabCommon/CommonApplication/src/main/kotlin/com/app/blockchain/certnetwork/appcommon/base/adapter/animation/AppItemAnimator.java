...
public class AppItemAnimator extends SimpleItemAnimator {
    ...
    public AppItemAnimator() {
        super();
        setSupportsChangeAnimations(false);
    }

    public AppItemAnimator(Interpolator interpolator) {
        super();
    ...
    private void preAnimateRemove(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimateViewHolderInterface) {
            ((AnimateViewHolderInterface) holder).preAnimateRemoveImpl(holder);
        }
    }
    ...
    private void preAnimateAdd(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimateViewHolderInterface) {
            ((AnimateViewHolderInterface) holder).preAnimateAddImpl(holder);
        }
    }

    private void doAnimateRemove(final RecyclerView.ViewHolder holder) {
        if (holder instanceof AnimateViewHolderInterface) {
            ((AnimateViewHolderInterface) holder).animateRemoveImpl(holder, new DefaultRemoveVpaListener(holder));
        }
    ...
    private void doAnimateAdd(final RecyclerView.ViewHolder holder) {
        if (holder instanceof AnimateViewHolderInterface) {
            ((AnimateViewHolderInterface) holder).animateAddImpl(holder, new DefaultAddVpaListener(holder));
        }
    ...
    public void endAnimation(ViewHolder item) {
        ...
        // TODO if some other animations are chained to end, how do we consume them as well?
        ...
        // animations should be ended by the consume above.
