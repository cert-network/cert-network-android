...
class PrivateKey constructor(
        private val hdKey: HdKey) : Key {

    override
    val byteArray: ByteArray get() = hdKey.key

    override
    val parse256: BigInteger get() = byteArray.parse256

    override
    val postEncrypt: String get() = hdKey.crypto?.postEncryptPrivateKey(hdKey.key) ?: ""
