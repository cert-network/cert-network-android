...
class RealmConfigStore {
    companion object {
        ...
        fun <T : Any> initModule(cls: Class<T>, realmConfig: RealmConfiguration) {
            ...
            if (annotation != null) {
                ...
                moduleAnnotation.classes
                        ...
                        .forEach { clazz -> init(clazz.java as Class<RealmModel>, realmConfig) }
                moduleAnnotation.classes
                        .filter { clazz -> clazz.java.superclass == RealmObject::class.java }
                        .forEach { clazz -> init(clazz.java as Class<RealmObject>, realmConfig) }
            }
        }
